...
const NewMessageInput = ({
  ...
  const handlePressEnter = useCallback(async () => {
    ...
    onPressEnter(ids);
    setFileList([]);
  }, [fileList, onPressEnter, value, isUploadingFile]);
  ...
  return (
    <Flex gap={0} vertical className={styles.messageInputWrapper}>
      <Flex gap={10} align="center" className={styles.messageInputWrapper2}>
        <Input
          size="large"
